...
import { GroupType } from '../../models/refactor/group.model';
...
export enum GroupsActionsTypes {
  ...
  // FetchStaticManageGroupData = '[Groups] Fetch Static Group Manage Data',
  FETCH_STATIC_MANAGE_GROUP_DATA = '[Groups] Fetch Static Group Manage Data',
  // StaticManageGroupDataFetched = '[Groups] Static Group Manage Data Fetched',
  FETCH_STATIC_MANAGE_GROUP_DATA_FAIL = '[Groups] Fetch Static Group Manage Data Fail',
  FETCH_STATIC_MANAGE_GROUP_DATA_SUCCESS = '[Groups] Fetch Static Group Manage Data Success',

  // LoadGroups = '[Groups] Load',
  LOAD_GROUPS = '[Groups] Load',
  LOAD_GROUPS_SUCCESS = '[Groups] Load Success',
  // LOAD_GROUPS_FAIL = '[Groups] Load Fail',
...
export class FetchStaticManageGroupData implements Action {
  // readonly type = GroupsActionsTypes.FetchStaticManageGroupData;
  readonly type = GroupsActionsTypes.FETCH_STATIC_MANAGE_GROUP_DATA;
  constructor(public payload: { groupid: string }) { }
}

export class FetchStaticManageGroupDataFail implements Action {
  readonly type = GroupsActionsTypes.FETCH_STATIC_MANAGE_GROUP_DATA_FAIL;
  constructor() { }
}

export class FetchStaticManageGroupDataSuccess implements Action {
  // readonly type = GroupsActionsTypes.StaticManageGroupDataFetched;
  readonly type = GroupsActionsTypes.FETCH_STATIC_MANAGE_GROUP_DATA_SUCCESS;
  constructor(private payload: { groupid: string, staticData: { groupMembers: Member[], groupAvailableOrders: GroupAvailableOrders } }) { }
}

export class LoadGroups implements Action {
  // readonly type = GroupsActionsTypes.LoadGroups;
  readonly type = GroupsActionsTypes.LOAD_GROUPS;
...
export class LoadGroupsSuccess implements Action {
  ...
  readonly type = GroupsActionsTypes.LOAD_GROUPS_SUCCESS;
  // constructor(private payload: Group[]) { }
  constructor(public payload: { groupid: string, groupcurrency: string, groupname: string, groupdescription: string, groupmanagerid: string, staticManageData: { groupMembers: any, groupAvailableOrders: any } }[]) { }
};
...
export type GroupsActions = FetchStaticManageGroupData |
  FetchStaticManageGroupDataFail |
  FetchStaticManageGroupDataSuccess |
  LoadGroups |
  LoadGroupsSuccess
